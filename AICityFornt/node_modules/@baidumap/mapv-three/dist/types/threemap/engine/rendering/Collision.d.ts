...
export class RenderingCollision {
    ...
    */
    ...
    _computeObjectBoundingBox(result: any, px: any, py: any, margin: any, tolerance: any): {
        minX: any;
        minY: any;
        maxX: any;
        maxY: any;
    } | null;
    _insertAndCheckCollision(tree: any, boxes: any): boolean;
    _updateCollisionDataForObjects(objectDataMap: any): void;
    /**
     * 碰撞方块的外边距，主要影响碰撞体积
