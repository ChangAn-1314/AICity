...
export class DataSource {
    ...
    /** @private 过滤器 */
    private _filter;
    /** @private 源坐标类型，内部使用，先不对暴露 */
    private _sourceCoordType;
    /** @private 目标坐标类型，内部使用，先不对暴露 */
    private _targetCoordType;
    _options: {
        id?: string | undefined;
        attributes?: object | undefined;
    };
     ...
     * @private
     * 设置目标坐标类型
     * @param {string} value 目标坐标类型
     */
    private set targetCoordType(value);
    /**
     * @private
     * 获取目标坐标类型
     * @type {string}
     */
    private get targetCoordType();
    /**
     * @private
     * 获取源坐标类型
     * @type {string}
     */
    private get sourceCoordType();
}
