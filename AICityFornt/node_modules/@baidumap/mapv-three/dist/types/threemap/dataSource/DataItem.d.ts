...
export class DataItem {
    ...
    /** @private 数据是否有效 */
    private _isValid;
    _getTransformedCoordinates(sourceCoordType: any, targetCoordType: any): any;
    _transformedCoordinates: any;
    /**
     * 获取指定投影下的坐标
     ...
     * ```
     */
    getProjectedCoordinates(projection: object, index?: number, sourceCoordType: any, targetCoordType: any): any[];
    /**
     * 将数据转换为GeoJSON格式
