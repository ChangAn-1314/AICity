...
export class BaiduLaneVectorTileProvider extends VectorTileProvider {
    ...
    _materialFactory: MaterialFactory | null;
    /**
    ...
    _vctMapStyleDomain1: string | undefined;
...
import { TextureManager } from '../../parser/baidulane/core/TextureManager';
import { MaterialFactory } from '../../parser/baidulane/core/MaterialFactory';
