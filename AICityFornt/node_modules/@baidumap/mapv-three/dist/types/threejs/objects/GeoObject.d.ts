...
export class GeoObject extends ThreeObject {
    ...
    _proxyDataSource: any;
    _proxyDataSourceNeedsUpdate: boolean | undefined;
    /**
     * 设置object是否在下一帧更新
    ...
    /** @private */
    private _createProxyDataSource;
    /** @private */
    private _createMappedObjectProxy;
    /** @private */
    private _createLazyMappedArrayProxy;
    /**
     * 添加属性重命名
     * @param {string} key 原始属性名，该组件的属性名
     * @param {string} value 重命名后的属性名，数据源的属性名
     */
    addAttributeRename(key: string, value: string): void;
    /**
     * 移除属性重命名
     * @param {string} key 原始属性名
     */
    removeAttributeRename(key: string): void;
    /**
     * 清空属性重命名
     */
    clearAttributeRename(): void;
    /** @protected */
    ...
    onDispose(): void;
    /**
     * 销毁object上的geometry和material实例，释放资源, 调用`engine.remove(object)`会自动销毁资源，不需要手动调用
     */
    dispose(): void;
