...
export class Label extends GeoMesh {
    ...
    */
    ...
    boxes: any[];
    textBoxCalculator: TextBoxCalculator | undefined;
    bufferBuilder: GeometryBufferBuilder | undefined;
    ...
    isSplitArray(field: any, value: any): boolean;
    expandTextVariants(data: any): any[];
...
import { TextBoxCalculator } from './label/TextBoxCalculator';
import { GeometryBufferBuilder } from './label/GeometryBufferBuilder';
